...
const RatingModal = ({ ratingModal, setRatingModal }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            dispatch(addRating({ ...data.rating, orderId: ratingModal.orderId, productId: ratingModal.productId }))
    ...
    return (
        <div className='fixed inset-0 z-120 flex items-center justify-center bg-black/10'>
            <div className='bg-white p-8 rounded-lg shadow-lg w-96 relative'>
                ...
                ></textarea>
                <button onClick={handleSubmit} disabled={submitting} className='w-full bg-green-500 text-white py-2 rounded-md hover:bg-green-600 transition disabled:opacity-50'>
