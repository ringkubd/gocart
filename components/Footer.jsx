...
const Footer = () => {
    ...
    const socialIcons = [
        { icon: FacebookIcon, link: footer.social?.facebook || "https://www.facebook.com" },
        { icon: InstagramIcon, link: footer.social?.instagram || "https://www.instagram.com" },
        { icon: TwitterIcon, link: footer.social?.twitter || "https://twitter.com" },
        { icon: LinkedinIcon, link: footer.social?.youtube || "https://www.youtube.com" },
    ]
    ...
    const linkSections = [
        ...
        },
        {
            ...
            links: [
                ...
                { text: contact.address || "Dhaka, Bangladesh", path: '/', icon: MapPinIcon }
            ]
        }
    ];
