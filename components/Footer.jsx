...
const Footer = () => {
    ...
    const socialIcons = [
        { icon: FacebookIcon, link: footer.social?.facebook || "#" },
        { icon: InstagramIcon, link: footer.social?.instagram || "#" },
        { icon: TwitterIcon, link: footer.social?.twitter || "#" },
        { icon: LinkedinIcon, link: footer.social?.youtube || "#" },
    ]
