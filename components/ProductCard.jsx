        ...
        <div className='group max-xl:mx-auto relative'>
            <Link href={`/product/${product.id}`} className='block'>
                <div className='bg-[#F5F5F5] h-40 sm:w-60 sm:h-68 rounded-lg relative overflow-hidden'>
                    <Image width={500} height={500} className='absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition duration-300' src={product.images?.[0] || '/assets/product_img1.png'} alt="" onError={(e) => { e.currentTarget.src = '/assets/product_img1.png' }} />
